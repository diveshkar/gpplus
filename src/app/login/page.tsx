...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-1 items-center justify-center overflow-hidden bg-black px-6 py-12">
      {/* Background animation. No poster, so nothing static flashes before it
          loads on refresh; the dark overlay below covers the gap until it plays. */}
      <video
      ...
      {/* Overlays for contrast and a warm brand wash */}
